...
<head>
    ...
    <title>Forgot Password - Bug Tracking System</title>
...
<body class="text-center bg-light">
    <main class="form-signin mt-5">
        <form method="POST" action="index.php?controller=auth&action=forgotPassword">
            ...
            <h2 class="h5 mb-3 fw-normal">Reset your password</h2>
            ...
            <div class="mt-3">
                <a href="index.php?controller=auth&action=login" class="text-decoration-none">Back to login</a>
            </div>
